...
def _train(args):
    ...
    if not os.path.exists(model_gdrive_path):
        ...
        print('Model downloaded from gdrive and loaded successfully')
        
    print('***Attempting to load checkpoint file **')
    if not os.path.isfile(args.checkpoint_path + '/checkpoint.pth'):
        print('Checkpoint path doesnt exist..continuing with already downloaded model')
    else:
        print('Checkpoint path found !')
    ...
    trainer = pl.Trainer(max_epochs=5,
                        ...
                        strategy="ddp",
                        num_nodes=2,
                        logger=TensorBoardLogger("lightning_logs/", name="cifar100_resnet34_jan20_v0"),
